...
def test_azure_speech_synthesizes_script_to_mp3_via_sdk_endpoint(tmp_path, monkeypatch):
    ...
    meta = tts_azure_speech.synthesize_script_to_mp3(
        ...
        tts_config={
            ...
            'mode': 'sync',
            'speech_endpoint': 'https://ai-robo-sweden-resource.cognitiveservices.azure.com/',
    ...
    assert call['speech_config'].endpoint == 'https://ai-robo-sweden-resource.cognitiveservices.azure.com'
